...
with onglet1:
    ...
    note1 = st.number_input("Note de l'examen n°1", min_value=0, max_value=100, value=0)
    note2 = st.number_input("Note de l'examen n°2", min_value=0, max_value=100, value=0)
